...
$$(document).on('page:init', '.page[data-name="nuevaEnfermedad"]', function (e) {
 var i=1;
  $$('#masPaso').on('click',function(){ 
      $$('#agregarpasos').append('<li class="item-content item-input" ><div class="item-inner"><div class="item-title item-label">Texto </div><div class="item-input-wrap"><textarea placeholder="Ingrese texto que va aparecer en el paso" id="textoenfermedad'+i+'"></textarea><span class="input-clear-button"></span></div><div class="item-title item-label">Audio </div><div class="item-input-wrap bordeinferior"><input type="file" name="audio'+i+'" id="audio'+i+'" class="audios" onchange="getFileName(this,'+i+')" disabled></div></div></li>');

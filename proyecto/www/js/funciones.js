            ...
            .then(function(querySnapshot)
            {
                ...
                .then(function(querySnapshot){
                    ...
                    $$('.editar').on('click',function(){
                        ...
                        $$('#textoPaso'+num).removeClass('corto').addClass('largo');

...
$$(document).on('page:init', '.page[data-name="nuevaEnfermedad"]', function (e) {
    ...
    $$('.masPaso').on('click',function(){
        console.log("i: "+i);
        $$('#agregarpasos').append('<div class="card" id="paso'+i+'"><div class="card-header"><b>Paso:</b></div><div class="card-content card-content-padding"><textarea placeholder="Ingrese el texto del paso" id="textoenfermedad'+i+'" class="colorFondo"></textarea><div class="oculto textoerror" id="errortextoenfermedad'+i+'" >Completar este campo.</div><div class="oculto textoerror" id="error2textoenfermedad'+i+'" >La cantidad de caracteres debe ser menor a 170.</div></div><div class="card-content card-content-padding"><input type="file" class="audios" name="audio'+i+'" id="audio'+i+'" disabled><div class="oculto textoerror" id="erroraudio'+i+'" >Completar este campo.</div> <div class="oculto textoerror" id="error2audio'+i+'" >El archivo debe tener formato mp3.</div> <div class="oculto textoerror" id="error3audio'+i+'" >El archivo debe durar menos de 30 segundos.</div></div><div class="card-footer"><button class=" button button-small button-fill eli eliminarPaso" id="'+i+'">Eliminar</button></div></div>');
        if($$('#tituloE').val()==="")
        {
